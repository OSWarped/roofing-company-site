        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
            <div className="space-y-6 text-base leading-8 text-zinc-600 sm:text-lg">
              ...
              <p>
                The goal of this website is to make it easy for homeowners and
                property owners to clearly identify <strong className="text-zinc-900">{siteContent.companyName}</strong>,
                understand the services offered, and feel confident about who they
                are contacting for roofing work on the Mississippi Gulf Coast.
              </p>
              <p>
                The company serves Gulf Coast communities with a straightforward,
                professional approach centered on communication, honest estimates,
                and roofing solutions tailored to the property rather than a
