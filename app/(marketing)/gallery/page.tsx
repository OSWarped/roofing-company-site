...
export default async function GalleryPage() {
  ...
  return (
    <>
      {isSectionVisible(content, "galleryPageIntro") ? (
      ...
      {isSectionVisible(content, "galleryPageProjects") ? (
                ...
                >
                  ...
                  <div className="p-8">
                    <p className="text-sm font-semibold uppercase tracking-[0.18em] text-zinc-500">
                      {project.source === "database" ? content.serviceArea : "Project Placeholder"}
                    </p>
      ...
      {isSectionVisible(content, "galleryPageCta") ? (
