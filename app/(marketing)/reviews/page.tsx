...
const reviewGoals = [
  "I called Integrity Roofing and a real person answered the phone. I explained my issue. Tom came out the next day on time and did a wonderful job repairing my roof. I highly recommend this company. It’s so refreshing when a company does what they say they are going to do and at a fair price. Thanks Integrity Roofing and Tom.",
  "We are very pleased with the work done on our roof! They also handled the insurance for us and also made sure we were paid what we were owed from our insurance!",
